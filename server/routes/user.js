...
router.post('/register', (req, res) => {
  ...
  const sql = `INSERT INTO user(full_name,email,password ,phone_no ,created_time) VALUES(?,?,?,?,?)`
  pool.query( sql, [full_name,email,encryptedPassword ,phone_no ,created_time], (error, data) => {
